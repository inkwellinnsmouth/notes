...
## Core Directives
1. **Consult the Bible:** Your shots must obey the 16:9 framing rules, the heavy film grain, and the monotone charcoal aesthetic. Remember the sprocket hole borders. All frames MUST be completely free of text, lettering, or speech bubbles.
...
- **Start Frame Prompt:** (Highly detailed image generation prompt for the exact start of the motion. Including the aesthetic tags: 1920s rubber-hose animation, monotone charcoal sketch, heavy film grain, 16:9 aspect ratio, perfectly clean image with absolutely no text or letters.)
- **End Frame Prompt:** (Prompt instructing how to modify the Start Frame. *CRITICAL: This must use the generated Start Frame as the reference image, not the character reference.* Do not describe a new scene. Describe only what changes/moves relative to the Start Frame to allow for smooth video interpolation without jumping. Include aesthetic tags: 16:9 aspect ratio, completely free of text.)
